...
class CTeacher extends CPerson {
	...
	super(a,n); 		//passing values to the base class constructor
        subj = s;
    }
    public void disp() {	// member function
	super.disp();		// calling the base class memeber function - to overcome overriding
        System.out.println("Subject :" + subj);
    }
}
public class overridingPTS{
